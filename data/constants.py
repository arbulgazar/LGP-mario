...
## LGP-RELATED CONSTANTS ##
TRAINING_MULTIPLIER = 1
MARIO_X_VELOCITY = 5 * TRAINING_MULTIPLIER
MARIO_Y_VELOCITY = 10 * TRAINING_MULTIPLIER
JUMP_TIME = 0.3 / TRAINING_MULTIPLIER
MAXIMAL_STILL_TIME = 2000
...
GRAVITY = 1.01 * TRAINING_MULTIPLIER
JUMP_GRAVITY = .31 * TRAINING_MULTIPLIER
JUMP_VEL = -MARIO_Y_VELOCITY
FAST_JUMP_VEL = -12.5
MAX_Y_VEL = 1000
